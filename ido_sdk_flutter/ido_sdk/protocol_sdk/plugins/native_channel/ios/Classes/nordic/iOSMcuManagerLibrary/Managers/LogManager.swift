...
internal class LogManager: McuManager {
    ...
    internal func show(log: String? = nil, minIndex: UInt64? = nil, minTimestamp: Date? = nil, callback: @escaping McuMgrCallback<McuMgrLogResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func clear(callback: @escaping McuMgrCallback<McuMgrResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func moduleList(callback: @escaping McuMgrCallback<McuMgrResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func levelList(callback: @escaping McuMgrCallback<McuMgrLevelListResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func logsList(callback: @escaping McuMgrCallback<McuMgrLogListResponse>) {
