...
internal class DefaultManager: McuManager {
    ...
    internal enum ResetBootMode: UInt8, CustomStringConvertible, CaseIterable {
        case normal = 0
        case bootloader = 1
    ...
    internal enum ApplicationInfoFormat: String {
        case kernelName = "s"
        case nodeName = "n"
    ...
    internal enum BootloaderInfoQuery: String {
        case name = ""
        case mode = "mode"
    ...
    internal func echo(_ echo: String, callback: @escaping McuMgrCallback<McuMgrEchoResponse>) {
    ...
    /// - parameter callback: The response callback.
    internal func consoleEcho(_ echoOn: Bool, callback: @escaping McuMgrCallback<McuMgrResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func taskStats(callback: @escaping McuMgrCallback<McuMgrTaskStatsResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func memoryPoolStats(callback: @escaping McuMgrCallback<McuMgrMemoryPoolStatsResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func readDatetime(callback: @escaping McuMgrCallback<McuMgrDateTimeResponse>) {
    ...
    /// - parameter callback: The response callback.
    internal func writeDatetime(date: Date = Date(), timeZone: TimeZone? = nil,
    ...
    /// - parameter callback: The response callback.
    internal func reset(bootMode: ResetBootMode = .normal, force: Bool = false,
                      callback: @escaping McuMgrCallback<McuMgrResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func params(callback: @escaping McuMgrCallback<McuMgrParametersResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func applicationInfo(format: Set<ApplicationInfoFormat>,
    ...
    /// - parameter callback: The response callback.
    internal func bootloaderInfo(query: BootloaderInfoQuery,
...
internal enum OSManagerError: UInt64, Error, LocalizedError {
    case noError = 0
    case unknown = 1
