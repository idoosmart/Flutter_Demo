 ...
 */
internal class ShellManager: McuManager {
    ...
    internal func execute(command: String, callback: @escaping McuMgrCallback<McuMgrExecResponse>) {
        execute(command: command, arguments: [], callback: callback)
    }
    
    internal func execute(command: String, arguments: [String],
...
internal enum ShellManagerError: UInt64, Error, LocalizedError {
    case noError = 0
    case unknown = 1
