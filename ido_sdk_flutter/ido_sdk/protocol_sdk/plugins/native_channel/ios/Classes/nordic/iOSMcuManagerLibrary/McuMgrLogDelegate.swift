...
internal enum McuMgrLogLevel: Int {
    case debug       = 0
    case verbose     = 1
    case info        = 5
    case application = 10
...
extension McuMgrLogLevel: Comparable {
    ...
    internal static func < (lhs: McuMgrLogLevel, rhs: McuMgrLogLevel) -> Bool {
...
internal enum McuMgrLogCategory: String {
...
internal protocol McuMgrLogDelegate: AnyObject {
...
internal extension McuMgrLogDelegate {
