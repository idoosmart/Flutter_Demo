...
extension CBOR {
    internal static func encode<T: CBOREncodable>(_ value: T, options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    internal static func encode<T: CBOREncodable>(_ array: [T], asByteString: Bool = false, options: CBOROptions = CBOROptions()) -> [UInt8] {
        if asByteString {
    ...
    internal static func encode<A: CBOREncodable, B: CBOREncodable>(_ dict: [A: B], options: CBOROptions = CBOROptions()) -> [UInt8] {
        return encodeMap(dict, options: options)
    }

    // MARK: - major 0: unsigned integer

    internal static func encodeUInt8(_ x: UInt8) -> [UInt8] {
        if (x < 24) { return [x] }
        else { return [0x18, x] }
    }

    internal static func encodeUInt16(_ x: UInt16) -> [UInt8] {
        return [0x19] + rawBytes(of: x)
    }

    internal static func encodeUInt32(_ x: UInt32) -> [UInt8] {
        return [0x1a] + rawBytes(of: x)
    }

    internal static func encodeUInt64(_ x: UInt64) -> [UInt8] {
    ...
    internal static func encodeNegativeInt(_ x: Int64) -> [UInt8] {
        assert(x < 0)
    ...
    internal static func encodeByteString(_ bs: [UInt8], options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    #if canImport(Foundation)
    internal static func encodeData(_ data: Data, options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    internal static func encodeString(_ str: String, options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    internal static func encodeArray<T: CBOREncodable>(_ arr: [T], options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    internal static func encodeMap<A: CBOREncodable, B: CBOREncodable>(_ map: [A: B], options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    internal static func encodeMap<A: CBOREncodable>(_ map: [A: Any?], options: CBOROptions = CBOROptions()) throws -> [UInt8] {
        if options.forbidNonStringMapKeys {
            try ensureStringKey(A.self)
        }
        var res: [UInt8] = []
    ...
    internal static func encodeTagged<T: CBOREncodable>(tag: Tag, value: T, options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    internal static func encodeSimpleValue(_ x: UInt8) -> [UInt8] {
        if x < 24 {
    ...
    internal static func encodeNull() -> [UInt8] {
        return [0xf6]
    }

    internal static func encodeUndefined() -> [UInt8] {
        return [0xf7]
    }

    internal static func encodeBreak() -> [UInt8] {
        return [0xff]
    }

    internal static func encodeFloat(_ x: Float) -> [UInt8] {
        return [0xfa] + rawBytes(of: x)
    }

    internal static func encodeDouble(_ x: Double) -> [UInt8] {
        return [0xfb] + rawBytes(of: x)
    }

    internal static func encodeBool(_ x: Bool) -> [UInt8] {
        return x ? [0xf5] : [0xf4]
    }
    ...
    internal static func encodeArrayStreamStart() -> [UInt8] {
        return [0x9f]
    }

    internal static func encodeMapStreamStart() -> [UInt8] {
        return [0xbf]
    }

    internal static func encodeStringStreamStart() -> [UInt8] {
        return [0x7f]
    }

    internal static func encodeByteStringStreamStart() -> [UInt8] {
        return [0x5f]
    }

    /// This is the same as a CBOR "break" value
    internal static func encodeStreamEnd() -> [UInt8] {
        return [0xff]
    }

    // TODO: unify definite and indefinite code
    internal static func encodeArrayChunk<T: CBOREncodable>(_ chunk: [T], options: CBOROptions = CBOROptions()) -> [UInt8] {
        var res: [UInt8] = []
    ...
    internal static func encodeMapChunk<A: CBOREncodable, B: CBOREncodable>(_ map: [A: B], options: CBOROptions = CBOROptions()) -> [UInt8] {
        if options.forbidNonStringMapKeys {
            try! ensureStringKey(A.self)
        }
        var res: [UInt8] = []
    ...
    #if canImport(Foundation)
    internal static func encodeDate(_ date: Date, options: CBOROptions = CBOROptions()) -> [UInt8] {
    ...
    internal static func encodeAny(_ any: Any?, options: CBOROptions = CBOROptions()) throws -> [UInt8] {
        switch any {
        case is Int:
...
internal enum CBOREncoderError: Error {
    case invalidType
