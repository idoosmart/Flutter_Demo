...
internal class CodableCBOREncoder {
    internal var useStringKeys: Bool = false
    internal var dateStrategy: DateStrategy = .taggedAsEpochTimestamp
    internal var forbidNonStringMapKeys: Bool = false
    ...
    internal func encode(_ value: Encodable) throws -> Data {
