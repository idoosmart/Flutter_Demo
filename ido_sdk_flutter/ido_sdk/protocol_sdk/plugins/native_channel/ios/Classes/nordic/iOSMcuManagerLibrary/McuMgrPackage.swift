...
internal struct McuMgrPackage {
    
    internal let images: [ImageManager.Image]
    internal let manifest: McuMgrManifest?
    internal let envelope: McuMgrSuitEnvelope?
    ...
    internal var isForSUIT: Bool { envelope != nil }
    
    internal func image(forResource resource: FirmwareUpgradeResource) -> ImageManager.Image? {
        switch resource {
        case .file(let name):
...
internal extension McuMgrPackage {
