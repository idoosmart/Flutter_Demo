...
internal class ImageManager: McuManager {
    
    // MARK: Image
    
    internal struct Image {
        internal let name: String?
        internal let image: Int
        internal let slot: Int
        internal let content: McuMgrManifest.File.ContentType
         ...
         */
        internal init(image: Int, slot: Int = 1, content: McuMgrManifest.File.ContentType = .unknown,
                    hash: Data, data: Data) {
            self.name = nil
            self.image = image
            self.slot = slot
        ...
        internal init(_ manifest: McuMgrManifest.File, hash: Data, data: Data) {
    ...
    internal func list(callback: @escaping McuMgrCallback<McuMgrImageStateResponse>) {
    ...
    internal func upload(data: Data, image: Int, offset: UInt64, alignment: ImageUploadAlignment,
    ...
    /// - parameter callback: The response callback.
    internal func test(hash: [UInt8], callback: @escaping McuMgrCallback<McuMgrImageStateResponse>) {
    ...
    /// - parameter callback: The response callback.
    internal func confirm(hash: [UInt8]? = nil, callback: @escaping McuMgrCallback<McuMgrImageStateResponse>) {
    ...
    internal func upload(images: [Image], using configuration: FirmwareUpgradeConfiguration = FirmwareUpgradeConfiguration(),
    ...
    ///
    /// - parameter callback: The response callback.
    internal func erase(callback: @escaping McuMgrCallback<McuMgrResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func coreList(callback: @escaping McuMgrCallback<McuMgrResponse>) {
    ...
    /// - parameter callback: The response callback.
    internal func coreLoad(offset: UInt, callback: @escaping McuMgrCallback<McuMgrCoreLoadResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func coreErase(callback: @escaping McuMgrCallback<McuMgrResponse>) {
    ...
    /**
     ...
     - parameter callback: The response callback.
     */
    internal func slotInfo(callback: @escaping McuMgrCallback<McuMgrSlotInfoResponse>) {
    ...
    internal func cancelUpload(error: Error? = nil) {
        objc_sync_enter(self)
        if uploadState == .none {
...
internal enum ImageUploadAlignment: UInt64, Codable, CaseIterable, CustomStringConvertible, CustomDebugStringConvertible {
...
internal enum ImageUploadError: Error, LocalizedError {
...
internal enum ImageManagerError: UInt64, Error, LocalizedError {
    case noError = 0
    case unknown = 1
...
internal protocol ImageUploadDelegate: AnyObject {
