 ...
 */
internal typealias McuSequenceNumber = UInt8
...
internal class McuManager : NSObject {
    ...
    internal static let COAP_PATH = "/omgr"
    
    /// Header Key for CoAP Payloads.
    internal static let HEADER_KEY = "_h"
    ...
    internal static let DEFAULT_SEND_TIMEOUT_SECONDS = 40
    ...
    internal static let FAST_TIMEOUT = 10
    ...
    internal init(group: McuMgrGroup, transport: McuMgrTransport) {
        self.group = group
    ...
    internal func send<T: McuMgrResponse, R: RawRepresentable>(op: McuMgrOperation, commandId: R, payload: [String:CBOR]?,
    ...
    internal func send<T: McuMgrResponse, R: RawRepresentable>(op: McuMgrOperation, flags: UInt8,
    ...
    internal func send<T: McuMgrResponse>(data: Data, timeout: Int, callback: @escaping McuMgrCallback<T>) {
    ...
    internal static func buildPacket<R: RawRepresentable>(scheme: McuMgrScheme,
    ...
    internal static func dateToString(date: Date, timeZone: TimeZone? = nil) -> String {
     ...
     */
    internal func setMtu(_ mtu: Int) throws  {
    ...
    internal static func getDefaultMtu(scheme: McuMgrScheme) -> Int {
        switch scheme {
...
internal typealias McuMgrCallback<T: McuMgrResponse> = (T?, Error?) -> Void

// MARK: - McuManagerError

internal enum McuManagerError: Error, LocalizedError {
...
internal enum McuMgrGroup: UInt16 {
...
internal enum McuMgrVersion: UInt8, CustomDebugStringConvertible {
    case SMPv1 = 0
    case SMPv2 = 1
...
/// The mcu manager operation defines whether the packet sent is a read/write
/// and request/response.
internal enum McuMgrOperation: UInt8 {
    case read           = 0
    case readResponse   = 1
    case write          = 2
...
internal enum McuMgrError: Error, LocalizedError {
    case returnCode(_ rc: McuMgrReturnCode)
...
internal class McuMgrGroupReturnCode: CBORMappable {
    
    internal var group: UInt64 = 0
    ...
    internal init(map: [CBOR: CBOR]) throws {
    ...
    internal func groupError() -> LocalizedError? {
 ...
 */
internal enum McuMgrReturnCode: UInt64, Error {
    case ok                = 0
    case unknown           = 1
    case noMemory          = 2
    case inValue           = 3
