...
internal enum McuMgrTransportState {
    case connected, disconnected
}

/// The connection state observer protocol.
internal protocol ConnectionObserver: AnyObject {
...
internal typealias ConnectionCallback = (ConnectionResult) -> Void

internal enum McuMgrTransportError: Error, Hashable {
...
internal protocol McuMgrTransport: AnyObject {
