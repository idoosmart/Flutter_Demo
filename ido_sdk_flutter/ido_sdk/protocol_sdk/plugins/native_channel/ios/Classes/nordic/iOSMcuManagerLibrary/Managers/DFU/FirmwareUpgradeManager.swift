...
internal class FirmwareUpgradeManager: FirmwareUpgradeController, ConnectionObserver {
    ...
    internal weak var logDelegate: McuMgrLogDelegate? {
        didSet {
    ...
    internal init(transport: McuMgrTransport, delegate: FirmwareUpgradeDelegate?) {
    ...
    internal func start(package: McuMgrPackage,
    ...
    internal func start(hash: Data, data: Data, using configuration: FirmwareUpgradeConfiguration = FirmwareUpgradeConfiguration()) {
    ...
    /// - parameter configuration: Fine-tuning of details regarding the upgrade process.
    internal func start(images: [ImageManager.Image], using configuration: FirmwareUpgradeConfiguration = FirmwareUpgradeConfiguration()) {
     ...
     */
    internal func uploadResource(_ resource: FirmwareUpgradeResource, data: Data) {
        objc_sync_enter(self)
    ...
    internal func isPaused() -> Bool {
        return paused
    }
    
    internal func isInProgress() -> Bool {
        return state.isInProgress() && !paused
    }
    
    internal func setUploadMtu(mtu: Int) throws {
    ...
    internal func transport(_ transport: McuMgrTransport, didChangeStateTo state: McuMgrTransportState) {
...
internal struct FirmwareUpgradeConfiguration: Codable {
     ...
     */
    internal var estimatedSwapTime: TimeInterval
    /**
     ...
     */
    internal var eraseAppSettings: Bool
    /**
     ...
     */
    internal var pipelineDepth: Int
    /**
     ...
     */
    internal var byteAlignment: ImageUploadAlignment
    /**
     ...
     */
    internal var reassemblyBufferSize: UInt64
    /**
     ...
     */
    internal var upgradeMode: FirmwareUpgradeMode
    /**
     ...
     */
    internal var bootloaderMode: BootloaderInfoResponse.Mode
    
    /**
     SMP Pipelining is considered Enabled for `pipelineDepth` values larger than `1`.
     */
    internal var pipeliningEnabled: Bool { pipelineDepth > 1 }
    
    internal init(estimatedSwapTime: TimeInterval = 0.0, eraseAppSettings: Bool = false, 
...
extension FirmwareUpgradeManager: ImageUploadDelegate {
    ...
    internal func uploadDidFail(with error: Error) {
        // If the upload fails, fail the upgrade.
        fail(error: error)
    }
    
    internal func uploadDidCancel() {
        DispatchQueue.main.async { [weak self] in
...
extension FirmwareUpgradeManager: SuitManagerDelegate {
    ...
    internal func uploadRequestsResource(_ resource: FirmwareUpgradeResource) {
...
internal enum FirmwareUpgradeError: Error, LocalizedError {
    case unknown(String)
...
internal enum FirmwareUpgradeMode: Codable, CustomStringConvertible, CustomDebugStringConvertible, CaseIterable {
...
internal protocol FirmwareUpgradeDelegate: AnyObject {
...
internal protocol SuitFirmwareUpgradeDelegate: FirmwareUpgradeDelegate {
...
extension FirmwareUpgradeImage: Equatable {
    ...
    internal static func == (lhs: FirmwareUpgradeImage, rhs: FirmwareUpgradeImage) -> Bool {
