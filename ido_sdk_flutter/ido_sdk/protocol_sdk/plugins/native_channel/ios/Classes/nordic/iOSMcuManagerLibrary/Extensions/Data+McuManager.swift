...
internal extension Data {
    ...
    struct HexEncodingOptions: OptionSet {
        internal static let upperCase = HexEncodingOptions(rawValue: 1 << 0)
        internal static let byteSpacing = HexEncodingOptions(rawValue: 1 << 1)
        internal static let prepend0x = HexEncodingOptions(rawValue: 1 << 2)
        internal static let twoByteSpacing = HexEncodingOptions(rawValue: 1 << 3)
        internal static let reverseEndianness = HexEncodingOptions(rawValue: 1 << 4)
