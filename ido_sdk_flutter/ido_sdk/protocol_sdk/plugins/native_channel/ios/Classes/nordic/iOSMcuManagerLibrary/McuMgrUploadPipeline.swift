...
internal struct McuMgrUploadPipeline {
    ...
    internal init(adopting configuration: FirmwareUpgradeConfiguration, over transport: McuMgrTransport) {
    ...
    mutating internal func pipelinedSend(ofSize imageSize: Int, using sendFrom: @escaping (_ offset: UInt64) -> UInt64) {
    ...
    mutating internal func receivedData(with offset: UInt64) {
    ...
    internal func allPacketsReceived() -> Bool {
