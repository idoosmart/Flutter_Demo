...
extension CBOR {
    static internal func decode(_ input: [UInt8], options: CBOROptions = CBOROptions()) throws -> CBOR? {
...
internal class CBORDecoder {
    ...
    internal var options: CBOROptions
    private var currentDepth = 0

    internal init(stream: CBORInputStream, options: CBOROptions = CBOROptions()) {
        self.istream = stream
        self.options = options
    }

    internal init(input: ArraySlice<UInt8>, options: CBOROptions = CBOROptions()) {
        self.istream = ArraySliceUInt8(slice: input)
        self.options = options
    }

    internal init(input: [UInt8], options: CBOROptions = CBOROptions()) {
    ...
    internal func decodeItem() throws -> CBOR? {
