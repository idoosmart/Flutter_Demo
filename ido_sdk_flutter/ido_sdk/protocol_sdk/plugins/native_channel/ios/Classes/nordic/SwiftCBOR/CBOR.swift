...
internal indirect enum CBOR : Equatable, Hashable,
    ...
    internal subscript(position: CBOR) -> CBOR? {
        get {
    ...
    internal init(nilLiteral: ()) { self = .null }
    ...
    internal init(extendedGraphemeClusterLiteral value: String) { self = .utf8String(value) }
    internal init(unicodeScalarLiteral value: String) { self = .utf8String(value) }
    internal init(stringLiteral value: String) { self = .utf8String(value) }
    internal init(arrayLiteral elements: CBOR...) { self = .array(elements) }
    internal init(dictionaryLiteral elements: (CBOR, CBOR)...) {
    ...
    internal init(booleanLiteral value: Bool) { self = .boolean(value) }
    internal init(floatLiteral value: Float32) { self = .float(value) }

    internal static func ==(lhs: CBOR, rhs: CBOR) -> Bool {
        switch (lhs, rhs) {
    ...
    internal struct Tag: RawRepresentable, Equatable, Hashable {
...
extension CBOR.Tag {
    internal static let standardDateTimeString = CBOR.Tag(rawValue: 0)
    internal static let epochBasedDateTime = CBOR.Tag(rawValue: 1)
    internal static let positiveBignum = CBOR.Tag(rawValue: 2)
    internal static let negativeBignum = CBOR.Tag(rawValue: 3)
    internal static let decimalFraction = CBOR.Tag(rawValue: 4)
    internal static let bigfloat = CBOR.Tag(rawValue: 5)

    // 6...20 unassigned

    internal static let expectedConversionToBase64URLEncoding = CBOR.Tag(rawValue: 21)
    internal static let expectedConversionToBase64Encoding = CBOR.Tag(rawValue: 22)
    internal static let expectedConversionToBase16Encoding = CBOR.Tag(rawValue: 23)
    internal static let encodedCBORDataItem = CBOR.Tag(rawValue: 24)

    // 25...31 unassigned

    internal static let uri = CBOR.Tag(rawValue: 32)
    internal static let base64Url = CBOR.Tag(rawValue: 33)
    internal static let base64 = CBOR.Tag(rawValue: 34)
    internal static let regularExpression = CBOR.Tag(rawValue: 35)
    internal static let mimeMessage = CBOR.Tag(rawValue: 36)
    internal static let uuid = CBOR.Tag(rawValue: 37)

    // 38...55798 unassigned

    internal static let selfDescribeCBOR = CBOR.Tag(rawValue: 55799)
}
