...
internal class StatsManager: McuManager {
    ...
    internal func read(module: String, callback: @escaping McuMgrCallback<McuMgrStatsResponse>) {
    ...
    ///
    /// - parameter callback: The response callback.
    internal func list(callback: @escaping McuMgrCallback<McuMgrStatsListResponse>) {
...
internal enum StatsManagerError: UInt64, Error, LocalizedError {
    case noError = 0
    case unknown = 1
    case invalidGroup = 2
