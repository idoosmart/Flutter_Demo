...
internal extension McuMgrBleTransport {
 ...
 */
internal struct DefaultTransportConfiguration: McuMgrBleTransport.Configuration {
    internal init() {}
    
    internal let serviceUUID: CBUUID = CBUUID(string: "8D53DC1D-1DB7-4CD3-868B-8A527460AA84")
    internal let characteristicUUUID: CBUUID = CBUUID(string: "DA2E7828-FBCE-4E01-AE9E-261174997C48")
}
