...
internal class McuMgrHeader {
    
    /// Header length.
    internal static let HEADER_LENGTH = 8
    
    internal let version: UInt8!
    internal let op: UInt8!
    internal let flags: UInt8!
    internal let length: UInt16!
    internal let groupId: UInt16!
    internal let sequenceNumber: McuSequenceNumber!
    internal let commandId: UInt8!
    ...
    internal init(version: UInt8, op: UInt8, flags: UInt8, length: UInt16,
    ...
    internal static func build(version: UInt8, op: UInt8, flags: UInt8, len: UInt16, group: UInt16,
...
internal enum McuMgrHeaderParseError: Error, LocalizedError {
