...
void ApiAlexaHostSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<ApiAlexaHost> *api) {
  /// token 变更，空为退出状态
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.alexa_channel.ApiAlexaHost.onTokenChanged"
  ...
  /// 创建下行流
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.alexa_channel.ApiAlexaHost.createDownStream"
        binaryMessenger:binaryMessenger
        codec:ApiAlexaHostGetCodec()];
    if (api) {
  ...
  /// 关闭下行流
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.alexa_channel.ApiAlexaHost.closeDownStream"
        binaryMessenger:binaryMessenger
        codec:ApiAlexaHostGetCodec()];
    if (api) {
  ...
  /// jsonBody 参数
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.alexa_channel.ApiAlexaHost.createUploadStream"
        binaryMessenger:binaryMessenger
        codec:ApiAlexaHostGetCodec()];
    if (api) {
  ...
  /// 关闭上行流
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.alexa_channel.ApiAlexaHost.closeUploadStream"
        binaryMessenger:binaryMessenger
        codec:ApiAlexaHostGetCodec()];
    if (api) {
  ...
  /// ask 音频流数据（由设备采集）
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.alexa_channel.ApiAlexaHost.askAudioData"
        binaryMessenger:binaryMessenger
        codec:ApiAlexaHostGetCodec()];
    if (api) {
...
- (void)replyAudioDataMessageId:(NSString *)arg_messageId data:(FlutterStandardTypedData *)arg_data isEnd:(NSNumber *)arg_isEnd completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.alexa_channel.ApiAlexaFlutter.replyAudioData"
...
- (void)onUploadStreamErrorError:(ApiAlexaError *)arg_error completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.alexa_channel.ApiAlexaFlutter.onUploadStreamError"
      binaryMessenger:self.binaryMessenger
      codec:ApiAlexaFlutterGetCodec()];
...
- (void)downStreamDataData:(FlutterStandardTypedData *)arg_data completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.alexa_channel.ApiAlexaFlutter.downStreamData"
      binaryMessenger:self.binaryMessenger
      codec:ApiAlexaFlutterGetCodec()];
...
- (void)onDownStreamErrorError:(ApiAlexaError *)arg_error completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.alexa_channel.ApiAlexaFlutter.onDownStreamError"
      binaryMessenger:self.binaryMessenger
      codec:ApiAlexaFlutterGetCodec()];
  [channel sendMessage:@[arg_error ?: [NSNull null]] reply:^(id reply) {
    completion(nil);
...
- (void)logLogMsg:(NSString *)arg_logMsg completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.alexa_channel.ApiAlexaFlutter.log"
      binaryMessenger:self.binaryMessenger
      codec:ApiAlexaFlutterGetCodec()];
