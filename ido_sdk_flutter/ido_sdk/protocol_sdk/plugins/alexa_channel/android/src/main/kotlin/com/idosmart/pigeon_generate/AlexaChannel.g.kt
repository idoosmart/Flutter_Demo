...
package com.idosmart.pigeon.api_channel
...
interface ApiAlexaHost {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: ApiAlexaHost?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.alexa_channel.ApiAlexaHost.onTokenChanged", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.alexa_channel.ApiAlexaHost.createDownStream", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.alexa_channel.ApiAlexaHost.closeDownStream", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.alexa_channel.ApiAlexaHost.createUploadStream", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val urlArg = args[0] as String
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.alexa_channel.ApiAlexaHost.closeUploadStream", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.alexa_channel.ApiAlexaHost.askAudioData", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
...
class ApiAlexaFlutter(private val binaryMessenger: BinaryMessenger) {
  ...
  fun replyAudioData(messageIdArg: String, dataArg: ByteArray, isEndArg: Boolean, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.alexa_channel.ApiAlexaFlutter.replyAudioData", codec)
  ...
  fun onUploadStreamError(errorArg: ApiAlexaError, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.alexa_channel.ApiAlexaFlutter.onUploadStreamError", codec)
  ...
  fun downStreamData(dataArg: ByteArray, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.alexa_channel.ApiAlexaFlutter.downStreamData", codec)
  ...
  fun onDownStreamError(errorArg: ApiAlexaError, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.alexa_channel.ApiAlexaFlutter.onDownStreamError", codec)
    channel.send(listOf(errorArg)) {
      callback()
    }
  }
  fun log(logMsgArg: String, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.alexa_channel.ApiAlexaFlutter.log", codec)
