...
class CustomPrinter extends LogPrinter {
  ...
  static final _fileLineStackTraceRegex =
  RegExp(r'(\(?:package:)?(dart:[^\s]+|[^\s]+\))');
  ...
  bool _discardDeviceStacktraceLine(String line) {
    ...
    return match.group(2)!.startsWith('package:logger') ||
        match.group(2)!.startsWith('package:ido_logger');
  }
  ...
  bool _discardWebStacktraceLine(String line) {
    ...
    return match.group(1)!.startsWith('packages/logger') ||
        match.group(1)!.startsWith('package:ido_logger') ||
  ...
  String _getPrefixes(Level level) {
  ...
  List<String> _formatAndPrint(
    ...
    if (stacktrace != null) {
      if (methodCount == 0) {
        // 获取所在行
        final match = _fileLineStackTraceRegex.firstMatch(stacktrace);
        if (isDebug) {
          // debug下，添加所在文件打印
          message = '$message ${match?.group(0) ?? ''}';
        }
      }else {
    ...
    if (time != null) {
      ...
      message = '${_getPrefixes(level)}$verticalLineAtLevel$time: $message';
