...
import com.idosmart.bluetooth.bt.BTDeviceScanManager
import com.idosmart.bluetooth.bt.IBTScanListener
import com.idosmart.bluetooth.utils.ByteDataConvertUtil
import com.idosmart.bluetooth.logger.Logger.e
...
//            p("[SPPConnector] receive <= " + ByteDataConvertUtil.bytesToHexString(temp))
    ...
    private fun write(data: ByteArray?): Boolean {
        ...
        p("[SPPConnector] send[" + data.size + "] => " + ByteDataConvertUtil.bytesToHexString(data, ByteDataConvertUtil.LIMITHEXLEN))
        if (!isConnected) {
