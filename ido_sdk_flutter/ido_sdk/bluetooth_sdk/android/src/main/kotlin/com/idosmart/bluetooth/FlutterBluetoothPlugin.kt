package com.idosmart.bluetooth
...
import com.idosmart.bluetooth.ble.DeviceManager
import com.idosmart.bluetooth.ble.DeviceManager.createBTDevice
import com.idosmart.bluetooth.ble.DeviceManager.createBleDevice
import com.idosmart.bluetooth.ble.DeviceManager.locateBTDevice
import com.idosmart.bluetooth.ble.DeviceManager.locateBleDevice
import com.idosmart.bluetooth.ble.callback.BluetoothCallback
import com.idosmart.bluetooth.ble.config.BLEGattAttributes
import com.idosmart.bluetooth.ble.device.DeviceBusinessManager
import com.idosmart.bluetooth.ble.protocol.ProtoMaker
import com.idosmart.bluetooth.ble.scan.ScanLeCallBack
import com.idosmart.bluetooth.ble.scan.ScanManager
import com.idosmart.bluetooth.bt.A2dpConnectHelper
import com.idosmart.bluetooth.bt.A2dpManager
import com.idosmart.bluetooth.bt.IBondStateListener
import com.idosmart.bluetooth.bt.spp.ISPPConnectStateListener
import com.idosmart.bluetooth.bt.spp.ISPPDataListener
import com.idosmart.bluetooth.dfu.BleDFUConfig
import com.idosmart.bluetooth.dfu.BleDFUState
import com.idosmart.bluetooth.logger.LogTransfer
import com.idosmart.bluetooth.logger.Logger
import com.idosmart.bluetooth.proxy.MyMethodChannel
import com.idosmart.bluetooth.utils.*
import com.idosmart.bluetooth.notFoundDevice
import com.idosmart.bluetooth.utils.Constants.RequestMethod.AUTO_CONNECT
import com.idosmart.bluetooth.utils.Constants.RequestMethod.CANCEL_PAIR
import com.idosmart.bluetooth.utils.Constants.RequestMethod.CONNECT
import com.idosmart.bluetooth.utils.Constants.RequestMethod.CONNECT_SPP
import com.idosmart.bluetooth.utils.Constants.RequestMethod.DISCONNECT
import com.idosmart.bluetooth.utils.Constants.RequestMethod.DISCONNECT_SPP
import com.idosmart.bluetooth.utils.Constants.RequestMethod.GET_A2DP_STATE
import com.idosmart.bluetooth.utils.Constants.RequestMethod.GET_DEVICE_STATE
import com.idosmart.bluetooth.utils.Constants.RequestMethod.GET_DOCUMENT_PATH
import com.idosmart.bluetooth.utils.Constants.RequestMethod.GET_SPP_STATE
import com.idosmart.bluetooth.utils.Constants.RequestMethod.SEND_DATA
import com.idosmart.bluetooth.utils.Constants.RequestMethod.SEND_SPP_DATA
import com.idosmart.bluetooth.utils.Constants.RequestMethod.SET_IGNORE_PHONE_MODELS
import com.idosmart.bluetooth.utils.Constants.RequestMethod.START_DFU
import com.idosmart.bluetooth.utils.Constants.RequestMethod.START_PAIR
import com.idosmart.bluetooth.utils.Constants.RequestMethod.START_SCAN
import com.idosmart.bluetooth.utils.Constants.RequestMethod.STATE
import com.idosmart.bluetooth.utils.Constants.RequestMethod.STOP_SCAN
import com.idosmart.bluetooth.utils.ByteDataConvertUtil
import com.idosmart.bluetooth.utils.GsonUtil
import com.idosmart.bluetooth.utils.PairedDeviceUtils
...
class FlutterBluetoothPlugin : FlutterPlugin, MethodCallHandler,
    ...
    private fun onConnectResult(
        ...
        error: com.idosmart.bluetooth.utils.Constants.BleConnectFailedError = Constants.BleConnectFailedError.DEFAULT,
...
//            result.error(BluetoothError.BLUETOOTH_INVALID_PARAMS)
        ...
        bleDevice?.autoConnectAndCheck(isDueToPhoneBluetoothSwitch = isDueToPhoneBluetoothSwitch)
        registerA2dpListener()
    }
...
//            result.error(BluetoothError.NO_BLUETOOTH_PERMISSIONS)
    ...
    override fun onSPPReceive(data: ByteArray?, deviceAddress: String) {
        ...
        Logger.p("spp receive <= ${ByteDataConvertUtil.bytesToHexString(data, ByteDataConvertUtil.LIMITHEXLEN)}")
        runOnUiThread {
