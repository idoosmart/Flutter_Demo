package com.idosmart.bluetooth.ble.reconnect

import android.bluetooth.BluetoothAdapter
import android.os.Build
import com.idosmart.bluetooth.ble.DeviceManager
import com.idosmart.bluetooth.ble.device.AbsIDOBleDevice
...
import com.idosmart.bluetooth.utils.OSUtil
...
open class AutoConnectBleDevice(deviceAddress: String) : AbsIDOBleDevice(deviceAddress) {
    ...
    fun autoConnectAndCheck(isDueToPhoneBluetoothSwitch: Boolean = false) {
        DeviceBusinessManager.autoConnectIntercept(macAddress = deviceAddress) {
            if (it) {
                Logger.e("[AutoConnectBle] autoConnectAndCheck is intercepted, device($deviceAddress) is in OTA mode.")
            } else {
                autoConnect(isDueToPhoneBluetoothSwitch)
            }
        }
    }
    /**
